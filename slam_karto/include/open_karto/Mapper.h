...
namespace karto
{
  ...
  public:
    ...
    void Update(const Pose2& rPose1, const Pose2& rPose2, const Matrix3& rCovariance)
    {
      ...
      m_PoseDifference = transform.TransformPose(rPose2);  //pose2相对pose1的变换
    ...
    {
      return m_PoseDifference; //pose2相对pose1的变换
    }
  ...
  public:
    ...
    inline void SmearPoint(const Vector2<kt_int32s>& rGridPoint)
    {
      ...
      int gridIndex = GridIndex(rGridPoint);  ////整个m_pCorrelationGrid栅格的 index
  ...
  private:
     ...
     * Default value is true.
     */
    Parameter<kt_bool>* m_pUseScanBarycenter;  //是否使用   loopClosure时 重心 / scan_pose
